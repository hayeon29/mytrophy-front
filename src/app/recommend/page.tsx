...
//     imageUrl:
//       'https://firebasestorage.googleapis.com/v0/b/nomo-62b92.appspot.com/o/steam3.png?alt=media&token=55345148-49fb-444f-bbfe-65623d3f4684',
//     price: '60,000원',
...
//     title: 'HELLDIVERS™ 2',
//     imageUrl:
//       'https://firebasestorage.googleapis.com/v0/b/nomo-62b92.appspot.com/o/steam2.png?alt=media&token=da0a75bb-5eb7-423a-ac25-d62809224da6',
//     price: '44,800원',
...
//     imageUrl:
//       'https://firebasestorage.googleapis.com/v0/b/nomo-62b92.appspot.com/o/steam1.png?alt=media&token=1c4c9231-18bf-4145-b62a-6bee24e6e131',
//     price: '무료',
  ...
  return (
    ...
    >
      <svg
        ...
        style={{ position: 'relative', top: '18px', left: '18px' }}
      >
              ...
              <div key={post.id} className="p-2">
                <div className="overflow-hidden rounded-3xl bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600">
                      <strong>출시일</strong> &nbsp;{' '}
                      {moment(post.releaseDate).format('YYYY.MM.DD')}
                    </p>
                    <p className="text-gray-600 flex">
                      <strong>한국어 지원 여부</strong> &nbsp;
                      {post.koIsPossible ? (
                        <Image
                        ...
                        <Image
                          ...
                          width={16}
                          height={16}
                          alt="korean support not available"
                        />
                      )}{' '}
                    </p>
                  </div>
