...
function GameReviewModal({ visible, onClose, onSubmit, gameName, backgroundImage }) {
    return (
            ...
            >
                ...
                <div className="relative z-10">
                    <ModalHeader className="flex flex-col items-center text-gray-800">
                        ...
                        <div className="font-semibold text-lg text-gray-500">게임이 마음에 드시나요?</div>
                    </ModalHeader>
